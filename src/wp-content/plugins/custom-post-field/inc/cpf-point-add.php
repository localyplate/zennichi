...
<div id="treecontrol" style="margin:20px 0;position:relative;">
    <span style="font-size:20pt">Add new type</span></br>
</div>
<form action="" method="POST" id="add_point">
	<table class="dpp">
		<tr>
			<th>Type Name</th>
			<td><input name="point_name" type="text" id="point_name" value="" /></td>
		</tr>
	</table>
