...
<div class="group">
    ...
    <div class="leftbox">
        ...
        if (isset($_POST['affiliation'])){
         ...
         if ($_SESSION['shogo_kana'] != ""): 
        ?>
        <?php foreach ($users_count as $user) : ?>
        <?php
        $kana01 = mb_substr($user->user_trade_name_kana, 0,1);
        if ( $kana01 == $_SESSION['shogo_kana']) {$users_kana[] = $user; };
        ?>
       ...
       <h3>検索結果</h3>
             <table class="search_table">
                 ...
                 <tbody>
           <?php if ( $_SESSION['shogo_kana'] != "") : ?>
           <?php  $i = 0; ?>
               <?php foreach($users_kana as $user) :?>
                <?php if($i >= $offset && $i < ($offset + $per_page)) : ?>
                     <tr>
                         <td class="w120">
                     ...
                     </tr><?php endif; $i++; endforeach; $users_count = $users_kana;?>
       <?php elseif($_SESSION['shogo_kana'] == "") : ?>
