...
<div class="group">
    <div class="group pankuzu">
        ...
        <p class="text-2">&gt;</p>
        <form name="year" method="post" action="<?php bloginfo('url'); ?>/magazine/">
    ...
    <p class="btn_link">
        <a href="/magazine/"><img src="/wp-content/themes/fk/images/topics/btn01.png" onmouseover="this.src='/wp-content/themes/fk/images/topics/btn01_on.png'" onmouseout="this.src='/wp-content/themes/fk/images/topics/btn01.png'" alt="一覧に戻る" title="一覧に戻る"></a>
    </p>
