     ...
     <div id="top">
      ...
      <section class="section-2 group" id="kensyujoho">
       ...
       <img class="news_left" src="<?php echo get_template_directory_uri(); ?>/images/top/news_ico.png" alt="" width="72" height="72">
        <p class="module1-p1"><span>2015/00/00</span></p>
        <p class="module1-p2"><a href="#">これはダミー文章です。実際の文言とは異なる予定です</a></p>
       </div>
       <div class="parts13"></div>
       <div class="module0 module0-1 group">
        <img class="news_left" src="<?php echo get_template_directory_uri(); ?>/images/top/news_ico02.png" alt="" width="72" height="72">
        <p class="module1-p1"><span>2015/00/00</span></p>
        <p class="module1-p2"><a href="#">これはダミー文章です。実際の文言とは異なる予定です</a></p>
       </div>
       <div class="parts14"></div>
       <div class="module0 module0-2 group">
       <img class="news_left" src="<?php echo get_template_directory_uri(); ?>/images/top/news_ico03.png" alt="" width="72" height="72">
        <p class="module1-p1"><span>2015/00/00</span></p>
        <p class="module1-p2"><a href="#">これはダミー文章です。実際の文言とは異なる予定です</a></p>
       </div>
       <div class="parts15 group">
        <img src="<?php echo get_template_directory_uri(); ?>/images/top/arrow_up_5.png" alt="" width="15" height="15">
        <p><a href="#">研修情報一覧へ</a></p>
       </div>
      </section>
      <section class="section-3 group" id="new_faq">
        ...
        <p class="parts17"><span>2015/00/00</span><img src="<?php echo get_template_directory_uri(); ?>/images/top/image_83.png" alt="" width="111" height="20"></p>
        <p class="parts18"><a href="#">これはダミー文章です。実際の文言とは異なります。これはダミー文章。</a></p>
       </div>
       <div class="parts19"></div>
       <div class="parts20 group">
        <p class="parts21"><span>2015/00/00</span><img src="<?php echo get_template_directory_uri(); ?>/images/top/image_83.png" alt="" width="111" height="20"></p>
        <p class="parts22"><a href="#">これはダミー文章です。実際の文言とは異なります。これはダミー文章。</a></p>
       </div>
       <div class="parts23"></div>
       <div class="parts24 group">
        <p class="parts25"><span>2015/00/00</span><img src="<?php echo get_template_directory_uri(); ?>/images/top/image_80.png" alt="" width="111" height="20"></p>
        <p class="parts26"><a href="#">これはダミー文章です。実際の文言とは異なります。これはダミー文章。</a></p>
       </div>
